...
export async function shopeeGet<TSuccess>(urlWithPath: string, parameters: ShopeeGetParameters, args: ShopeeGetArgs): Promise<HttpRequestResponse<TSuccess>> {
