...
export type DiscountListStatus = "upcoming" /** AINDA NÃO INICIOU  */ | "ongoing" /** EM ANDAMENTO */ | "expired" /** JÁ TERMINOU */ | "all"; /** TODOS (GERALMENTE USADO COMO FILTRO) */
...
export declare function get_discount_list(parameters?: Partial<RequestParameter>): Promise<ResponseSuccess>;
export {};
//# sourceMappingURL=get_discount_list.d.ts.map