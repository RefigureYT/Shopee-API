 ...
 */
export type GetItemBaseInfoResponse = ShopeeEnvelope<{
    item_list: GetItemBaseInfoResponseItemList[];
}>;
/**
 ...
 */
export declare function get_item_base_info(itemIdList: number[]): Promise<GetItemBaseInfoResponse>;
//# sourceMappingURL=get_item_base_info.d.ts.map