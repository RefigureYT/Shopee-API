 ...
 */
export declare function add_discount_item(discountId: number, itemOrItems: AddDiscountItem_ItemList[]): Promise<AddDiscountItemResponse>;
export {};
//# sourceMappingURL=add_discount_item.d.ts.map